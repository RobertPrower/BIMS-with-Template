...
<head>
  ...
  <title>BIMS | Manage Blotters</title>
  <!-- Favicon -->
        ...
        <main>
            <div class="container">
                <div class="container p-3">
                    <h2 class="main-title">Blotters Audit Trail</h2>
                    <div class="row pb-3">
                        <div class="col-md-8">
                            <!-- Buttons -->
                            <div class="d-flex justify-content-start" style="padding-left: 15px;">
                                 ...
                                 <?php require_once 'includes/blotterviewmodal.php';?>
...
<script src="js/blotteraudittrail.js"> </script>
