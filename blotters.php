                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <!-- End of first tab -->
                                <div class="tab-pane fade" id="complainants_tab_pane2" role="tabpanel"
                                    aria-labelledby="profile-tab" tabindex="0">
                                    <div class="table-wrapper otherparty users-table ">
                                        <BR>
                                        <table class="otherpartytable text-center">
                                ...
                                <!-- End of second tab -->
                                <div class="tab-pane fade" id="respondents_tab_pane2" role="tabpanel"
                                    aria-labelledby="contact-tab" tabindex="0">
                                    <div class="col-md-12">
                                        <br>
                                        <table class="table table-bordered text-center">
                                ...
                                <!-- End of Third tab -->
                                <div class="tab-pane fade" id="casedetails_tab_pane2" role="tabpanel"
                                    aria-labelledby="disabled-tab" tabindex="0">
                                    <div class="row">
                                        <div class="form-floating mt-3 mb-3 col-md-4">
                                            <input type="date" class="form-control" id="schedule_date"
                                ...
                                <!-- End of fourth tab -->
                                <div class="tab-pane fade" id="evidence_tab_pane2" role="tabpanel"
                                    aria-labelledby="disabled-tab" tabindex="0">
                                    <br>
                                    <div class="card">
                                        <div class="row m-3">
