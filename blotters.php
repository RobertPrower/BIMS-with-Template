...
<div class="page-flex">
  ...
  ?>
    ...
    <div class="main-wrapper">
                ...
                <div class="modal-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active complainant_respondent_tab" id="complainant_respondent_tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Complainant and Respondent Details</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link other_complainants_tab" id="other_complainants_tab" data-bs-toggle="tab" data-bs-target="#complainants_tab_pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Other Complainants</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link other_respondents_tab" id="other_respondents_tab" data-bs-toggle="tab" data-bs-target="#respondents_tab_pane" type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false">Other Respondents</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link case_details_tab" id="case_details_tab" data-bs-toggle="tab" data-bs-target="#casedetails_tab_pane" type="button" role="tab" aria-controls="disabled-tab-pane" aria-selected="false">Case Details</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link evidence_tab" id="evidence_tab" data-bs-toggle="tab" data-bs-target="#evidence_tab_pane" type="button" role="tab" aria-controls="disabled-tab-pane" aria-selected="false">Evidence</button>
                        </li>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 card m-4 px-3" style="border-radius: 10px;" style="padding: 10px;" id="ComplainantCard">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm complainantbtn" data-id="" data-status="" id="viewResorNonResfromBlot">View Details</button>
                                        </div>
                            ...
                            <div class="container mx-2">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 card m-3 p-3  d-flex justify-content-center align-items-center" style="border-radius: 10px;padding: 10px;object-fit: contain; max-width: 100%; max-height: 100%" id="RespondentCard">
                                    ...
                                    <div class="col-md-9 card m-4 px-3" style="border-radius: 10px;" style="padding: 10px;">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm respondentbtn" data-id="" data-status="" id="viewResorNonResfromBlot">View Details</button>
                                        </div>
                        ...
                        <div class="tab-pane fade" id="casedetails_tab_pane" role="tabpanel" aria-labelledby="disabled-tab" tabindex="0">
                            <div class="row">
                                ...
                                <div class="form-floating mt-3 mb-3 col-md-4">
                                    <input type="text" class="form-control" id="mediator" placeholder="" disabled/>
                                ...
                                <div class="form-floating mt-3 mb-3 col-md-4">
                                    <input type="text" class="form-control" id="resolution_date" name="incident_desc" placeholder="Enter Subdvision Here" disabled/>
                        ...
                        <!-- End of fourth tab -->
                        <div class="tab-pane fade" id="evidence_tab_pane" role="tabpanel" aria-labelledby="disabled-tab" tabindex="0">
                            <br>
                            <div class="card">
                                <div class="row m-3">
        ...
        <div class="modal fade" id="EditBlotterModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active complainant_respondent_tab" id="complainant_respondent_tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane2" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Complainant and Respondent Details</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="other_complainants_tab" data-bs-toggle="tab" data-bs-target="#complainants_tab_pane2" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Other Complainants</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="other_respondents_tab" data-bs-toggle="tab" data-bs-target="#respondents_tab_pane2" type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false">Other Respondents</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="case_details_tab" data-bs-toggle="tab" data-bs-target="#casedetails_tab_pane2" type="button" role="tab" aria-controls="disabled-tab-pane" aria-selected="false">Case Details</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="evidence_tab" data-bs-toggle="tab" data-bs-target="#evidence_tab_pane2" type="button" role="tab" aria-controls="disabled-tab-pane" aria-selected="false">Evidence</button>
                        </li>
                    ...
                    <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="col-md-9 card m-4 px-3" style="border-radius: 10px;" style="padding: 10px;" id="ComplainantCard">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex gap-2 ms-auto">
                                                <button type="button" class="btn btn-primary btn-sm complainantbtn" data-id="" data-status="" id="viewResorNonResfromBlot">View Details</button>
                                                <button type="button" class="btn btn-success btn-sm complainantbtn" data-id="" data-status="" id="edit_main_complainant">Edit</button>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 card m-4 px-3" style="border-radius: 10px;" style="padding: 10px;">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex gap-2 ms-auto">
                                                <button type="button" class="btn btn-primary btn-sm respondentbtn" data-id="" data-status="" id="viewResorNonResfromBlot">View Details</button>
                                                <button type="button" class="btn btn-success btn-sm complainantbtn" data-id="" data-status="" id="edit_main_respondent">Edit</button>
                                            </div>
                                        </div>
                        ...
                        <!-- End of fourth tab -->
                        <div class="tab-pane fade" id="evidence_tab_pane2" role="tabpanel" aria-labelledby="disabled-tab" tabindex="0">
                            <br>
                            <div class="card">
                                <div class="row m-3">
                                    <div class="col d-flex flex-column justify-content-center align-items-center">
...
<script src="js/selectresornonrestableload.js"></script>
