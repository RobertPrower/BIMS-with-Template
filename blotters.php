...
<body>
    ...
    <div class="page-flex">
        ...
        <div class="modal fade" id="EditMediatorsModal" tabindex="-1" aria-labelledby="EditBrgyOfficialsLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                <h1 class="modal-title fs-5" id="EditBrgyOfficialsLabel">Manage Mediators</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                <nav>
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab" tabindex="0">
                        <table class="table table-bordered mb-0 mt-3 text-center" id="mediatortable">
                            <thead>
                                <tr>
                                        <th>Last Name</th>
                                        <th>First Name</th>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered mb-0 text-center" id="deletedmediatortable">
                            <thead>
                                <tr>
                                        <th>Last Name</th>
                                        <th>First Name</th>
                        ...
                        <div class="row pb-3">
                            <div class="col-md-8">
                                ...
                                <div class="d-flex justify-content-start" style="padding-left: 15px;">
                                    ...
                                    <button type="button" class="btn btn-secondary me-2" id="editmediator" >Manage Mediators</button>    
