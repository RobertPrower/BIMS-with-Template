                          ...
                          <div class="card mb-4 mb-xl-0">
                              <div class="card-header">Administration Logo</div>
                                <div class="card-body text-center">
                                    ...
                                    <img class="img-account-profile rounded-circle mb-2" id="adminlogo" src="img/logos/<?php echo $brgylogo[0]; ?>" alt="">
                                    <!-- Profile picture help block-->
                                    <div class="small font-italic text-muted mb-4">JPG or PNG no larger than 5 MB</div>
                                    <!-- Profile picture upload button-->
                                    <button class="btn btn-primary changelogobtn" type="button" data-bs-toggle="modal" data-bs-target="#EditLogo" data-logo="1">Upload new image</button>
                                </div>
                          </div>
                      </div>
                      ...
                      <div class="col-xl-3">
                          ...
                          <div class="card mb-4 mb-xl-0">
                              <div class="card-header">City Logo</div>
                                <div class="card-body text-center">
                                    <!-- Profile picture image-->
                                    <img class="img-account-profile rounded-circle mb-2" id="citylogo" src="img/logos/<?php echo $brgylogo[1]; ?>" alt="">
                                    <!-- Profile picture help block-->
                                    <div class="small font-italic text-muted mb-4">JPG or PNG no larger than 5 MB</div>
                                    <!-- Profile picture upload button-->
                                    <button class="btn btn-primary changelogobtn" type="button" data-bs-toggle="modal" data-bs-target="#EditLogo" data-logo="2">Upload new image</button>
                                </div>
                          </div>
                      </div>
                      ...
                      <div class="col-xl-3">
                          ...
                          <div class="card mb-4 mb-xl-0">
                              <div class="card-header">Brgy Logo</div>
                                <div class="card-body text-center">
                                    <!-- Profile picture image-->
                                    <img class="img-account-profile rounded-circle mb-2" id="brgylogo" src="img/logos/<?php echo $brgylogo[3]; ?>" alt="">
                                    <!-- Profile picture help block-->
                                    <div class="small font-italic text-muted mb-4">JPG or PNG no larger than 5 MB</div>
                                    <!-- Profile picture upload button-->
                                    <button class="btn btn-primary changelogobtn" type="button" data-bs-toggle="modal" data-bs-target="#EditLogo" data-logo="3">Upload new image</button>
                                </div>
                          </div>
                      </div>
                      ...
                      <div class="col-xl-3  ">
                          ...
                          <div class="card mb-4 mb-xl-0">
                              <div class="card-header">Watermark</div>
                                <div class="card-body text-center">
                                    <!-- Profile picture image-->
                                    <img class="img-account-profile rounded-circle mb-2" id="watermark" src="img/logos/<?php echo $brgylogo[4]; ?>" alt="">
                                    <!-- Profile picture help block-->
                                    <div class="small font-italic text-muted mb-4">JPG or PNG no larger than 5 MB</div>
                                    <!-- Profile picture upload button-->
                                    <button class="btn btn-primary changelogobtn" type="button" data-bs-toggle="modal" data-bs-target="#EditLogo" data-logo="4">Upload new image</button>
                                </div>
                          </div>
                      </div>
                  </div>
                    ...
                    <div class="row">
                      ...
                      <div class="modal fade" id="EditLogo" tabindex="-1" aria-labelledby="EditLogoLabel" aria-hidden="true">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h1 class="modal-title fs-5" id="EditLogoLabel"></h1>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <form action="#" id="brgylogoform" enctype="multipart/form-data">                        
                            <div class="modal-body">
                              <!--For the container of the camera and Picture-->
                              <div class="col card" style="border-radius: 15px;">
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="submit" class="btn btn-primary SaveLogoBtn">Save changes</button>
                            </div>
                            </form>
                          </div>
                      </div>
