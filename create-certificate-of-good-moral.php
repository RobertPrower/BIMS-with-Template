...
<head>
  ...
  <title>Create Certificate of Good Moral</title>
  <!-- Favicon -->
...
<div class="page-flex">
  ...
  <div class="main-wrapper">
    ...
    <main class="main users chart-page" id="skip-target">
      <div class="container">
        <h2 class="main-title">Create Certificate of Good Moral</h2>
        <div class="row container">
          ...
          <form action="#" method="POST" id="certificatedetails">
            <div class="text-center row">
              ...
              <div class="form-floating mt-3 mb-3 col-md-3">
                  <input type="text" class="form-control" id="lname" name="lastname" placeholder="Enter Last Name Here" disabled/>
          ...
          <button type="button" id="generate_certificate" class="btn btn-success float-right"> Generate Certificate </button> 
          </div>
          </form>
