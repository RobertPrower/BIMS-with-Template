<?php 
    ...
    if($departmentno == 2 || $departmentno == 3){
...
<div class="page-flex">
  ...
  <div class="main-wrapper">
    ...
    <main class="main users chart-page" id="skip-target">
      <div class="container">
        <h2 class="main-title">Create Tricycle Pedicab Regulatory Services</h2>
        <div class="row container">
          ...
          <form action="#" id="formtoclear" method="POST" id="certificatedetails">
