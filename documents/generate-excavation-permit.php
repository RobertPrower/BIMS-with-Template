...
if($_SERVER['REQUEST_METHOD']==="POST"){
    ...
    $excavation_hnum= sanitizeData($_POST['house_num']?? null);
    $excavation_street= sanitizeData($_POST['street']?? null);
    $excavation_subd = sanitizeData($_POST['subd']?? null);
    $excavationaddress = $excavation_hnum .' '. $excavation_street. ' '. $excavation_subd;
    $purpose = "Securing Excavation Permit";

    $checkforempty = [$fname, $lname, $address, $presentedid, $IDnumber, $excavation_hnum, $excavation_street, $purpose];
    ...
    class MYPDF extends TCPDF {
        ...
        public function Header() {
            ...
            if (!empty($imglogo)) {
                ...
                if (isset($logo[3])) {
                    $this->Image("../img/logos/" . $logo[3], 175, 8, 25, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false); // Fourth image
                }
            } else {
