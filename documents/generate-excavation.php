...
$fileName = "certificate_of_excavation/"."generated_pdf_" . time() . ".pdf";
$username = null;
$issuingdeptno = null;
...
$directory = "certificate_of_excavation/";
$fileName = $_SERVER['DOCUMENT_ROOT'] . "/BIMS-with-Template/documents/certificate_of_excavation/generated_pdf_" . $nowtime . ".pdf";
...
$epermit="Securing Excavation Permit";
...
$html =
    '<div class="body">
        ...
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ang pagpapatunay na ito ipinagkaloob sa kahilingan ni
         <b class="bold">'.'  '.$name. '  '.'</b> upang magamit para sa kaniyang
         <b class="bold">'.' '.$epermit. ' '.'</b> na matatagpuan sa <b class="bold">'.' '.$address. ' '.'</b>
