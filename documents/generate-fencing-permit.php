...
if($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    $buildingaddress = $building_hnum .' '. $building_street. ' '. $building_subd;
    $permit_type= sanitizeData($_POST['purpose']?? null);
    $purpose = "Securing Fencing Permit "."(".$permit_type.")";

    $checkforempty=[$fname, $lname, $building_hnum, $building_street, $permit_type];
