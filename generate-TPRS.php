...
$tprsid=($_POST['tprs_id']);
$tprsname=utf8_decode($_POST['name']);
$tprsaddress=utf8_decode($_POST['address']);
$tprssex=utf8_decode($_POST['sex']);
$tprsage=utf8_decode($_POST['age']);
$tprcontactnum=utf8_decode($_POST['contactnum']);
$tprstoda=utf8_decode($_POST['toda']);
$tprsplatenum=utf8_decode($_POST['platenum']);
$tprschasisnum=utf8_decode($_POST['chasisnum']);
$tprsmakertype=utf8_decode($_POST['makertype']);
$tprsenginenum=utf8_decode($_POST['age']);
