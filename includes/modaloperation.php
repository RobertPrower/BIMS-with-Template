...
if($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    if ($operation_check == "SELECT_RESIDENT_TABLELOAD") {
        ...
        if (isset($nresid)) {
            ...
            try{
                ...
                echo '<tr><td colspan="11"><b>Error :'.$e->getMessage().'</b>';
            }
        } else {
            echo '<tr><td colspan="11"><b>Error : No ID Recieved</b></td></tr>';
        }
        ...
        // Query to fetch resident details based on the ID
        $query = "SELECT first_name, middle_name, last_name, suffix, CONCAT(house_num, ' ', street, ' ', subdivision,'
         ',district_brgy,' ',city,' ',province,' ',zipcode) AS address
    ...
    }else if($operation_check=="FETCH_IMG"){
