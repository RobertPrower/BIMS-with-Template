                ...
                <div class="modal-body">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <button class="nav-link" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nonres_profile-tab" type="button" role="tab"
                             aria-controls="nav-home" aria-selected="true">Profile</button>
                            <button class="nav-link" id="open-clearance-tab" data-bs-toggle="tab" data-bs-target="#nonres_clearance-tab" type="button" 
                            role="tab" aria-controls="nav-profile" aria-selected="false">Requested Documents</button>
                            <button class="nav-link" id="nav-blotters-tab" data-bs-toggle="tab" data-bs-target="#nonres_blotters" type="button" 
                            role="tab" aria-controls="nav-contact" aria-selected="false">Blotters Involved</button>
                        </div>
                    </nav>
                        <!------------------------------------------------------------------------------------------------------------>
                                                <!-- Profile Tab Content -->
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade" id="nonres_blotters" role="tabpanel" aria-labelledby="nav-contact-tab" tabindex="0">
                                <div class="users-table table-wrapper">
                                    ...
                                    <table class="users-table table-wrapper my-4" id="NonResidentBlotterTable">
                                        <thead>
                                            <tr class="users-table-info">
