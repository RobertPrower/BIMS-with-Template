        ...
        <main>
          ...
          <div class="container p-3">
                    ...
                    <div class="row pb-3">
                        <div class="col-md-8">
                            ...
                            <form id="UserSignup" action="includes/addresident.php" enctype="multipart/form-data" method="POST">
                             ...
                             <!-- View Users Modal -->
                            <form id="ViewUserForm" action="includes/addresident.php" enctype="multipart/form-data" method="POST">
                                <div class="modal fade" id="ViewUserModal" name="add" tabindex="-1" aria-labelledby="addBlotterModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="addBlotterModalLabel">View User</h5>
                                                <button type="button" class="btn-close btnClose" data-bs-dismiss="modal" id="up_closeButton" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <!-- Camera and Picture Container -->
                                                        ...
                                                        <div class="col card" style="border-radius: 15px; height: 400px">
                                                            <div class="text-center">
                                                                <div class="mt-3 mb-4">
                                                                    ...
                                                                    <h5><span class="badge rounded-pill text-bg-danger usernamelabel"></span></h5>
                                                    ...
                                                    <div class="col card" style="border-radius: 10px; padding: 10px; width: 150px;">
                                                        <div class="text-center row">
                                                            <div class="form-floating mt-2 mb-2">
                                                                <input type="text" class="form-control" id="view_fname" name="fname" placeholder="Enter First Name Here" disabled>
                                                                <label for="fname">First Name</label>
                                                            </div>
                                                            <div class="form-floating mt-2 mb-2">
                                                                <input type="text" class="form-control" id="view_mname" name="mname" placeholder="Enter Middle Name Here" disabled>
                                                                <label for="mname">Middle Name</label>
                                                            </div>
                                                            <div class="form-floating mt-2 mb-2">
                                                                <input type="text" class="form-control" id="view_lname" name="lname" placeholder="Enter Last Name Here" disabled>
                                                                <label for="lname">Last Name</label>
                                                            </div>
                                                            <div class="form-floating mt-2 mb-2">
                                                                <input type="text" class="form-control" id="view_suffix" name="suffix" placeholder="Enter Suffix Here" disabled>
                                                                <label for="suffix">Suffix</label>
                                                            </div>
                                                            <div class="form-floating mt-2 mb-2">
                                                                <select class="form-select" id="view_department" name="department" disabled>
                                                                    <option hidden selected>Select</option>
                                                                    <option value="1">Clearance</option>
                                                                    <option value="2">Secretariat Dept</option>
                                                                    <option value="3">Lupon</option>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" id="CloseButton" data-bs-dismiss="modal" class="btn btn-secondary">Close</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <form id="EditUserForm" action="includes/addresident.php" enctype="multipart/form-data" method="POST">
                            <div class="modal fade" id="EditUserProfile" name="add" tabindex="-1" aria-labelledby="addBlotterModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="addBlotterModalLabel">Edit User</h5>
                                            <button type="button" class="btn-close btnClose" data-bs-dismiss="modal" id="2closeButton" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <div class="row">
                                                <!-- Camera and Picture Container -->
                                                ...
                                                <div class="col card" style="border-radius: 10px; padding: 10px; width: 150px;">
                                                    <div class="text-center row">
                                                        <div class="form-floating mt-2 mb-2">
                                                            <input type="text" class="form-control" id="edit_fname" name="fname" placeholder="Enter First Name Here" required>
                                                            <label for="fname">First Name</label>
                                                        </div>
                                                        <div class="form-floating mt-2 mb-2">
                                                            <input type="text" class="form-control" id="edit_mname" name="mname" placeholder="Enter Middle Name Here">
                                                            <label for="mname">Middle Name</label>
                                                        </div>
                                                        <div class="form-floating mt-2 mb-2">
                                                            <input type="text" class="form-control" id="edit_lname" name="lname" placeholder="Enter Last Name Here" required>
                                                            <label for="lname">Last Name</label>
                                                        </div>
                                                        <div class="form-floating mt-2 mb-2">
                                                            <input type="text" class="form-control" id="edit_suffix" name="suffix" placeholder="Enter Suffix Here">
                                                            <label for="suffix">Suffix</label>
                                                        </div>
                                                        <div class="form-floating mt-2 mb-2">
                    ...
                    <div class="users-table table-wrapper">
                        ...
                        <table class="users-table table-striped" id="UsersTable" style="width:100%">
                            <thead>
                            <tr>
